...
if __name__ == '__main__':
    ...
    def minimization_function(means):
        ...
        sum_of_errors.append(get_sum_of_errors_squared(
            predicted = predicted[:, 3].reshape(granule_loader.granules[0].original_shape[0:2])[500:500 + 750, 0:0 + 600],
            original =  test_data[:, 3].reshape(granule_loader.granules[0].original_shape[0:2])[500:500 + 750, 0:0 + 600],
        )
